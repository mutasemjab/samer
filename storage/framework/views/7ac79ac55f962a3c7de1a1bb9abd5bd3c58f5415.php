...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> <?php echo e(__('messages.medical_history')); ?></label>
                            <input name="medical_history" id="medical_history" class="form-control" value="<?php echo e(old('medical_history')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> <?php echo e(__('messages.allergies')); ?></label>
                            <input name="allergies" id="allergies" class="form-control" value="<?php echo e(old('allergies')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\samer\resources\views/admin/users/create.blade.php ENDPATH**/ ?>