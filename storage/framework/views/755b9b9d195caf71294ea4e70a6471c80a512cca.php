...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><?php echo e(__('messages.Create_New_Appointment')); ?></h1>
    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="appointment_date"><?php echo e(__('messages.Appointment_datetime')); ?> <span class="text-danger">*</span></label>
                            <input type="datetime-local" name="appointment_datetime" id="appointment_datetime" class="form-control" value="<?php echo e(old('invoice_date', date('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo e(__('messages.Create_Appointment')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\samer\resources\views/admin/appointments/create.blade.php ENDPATH**/ ?>