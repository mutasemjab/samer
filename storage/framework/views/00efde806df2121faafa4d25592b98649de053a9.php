...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('banners.create')); ?>" class="btn btn-sm btn-success"> <?php echo e(__('messages.New')); ?>

                <?php echo e(__('messages.banners')); ?></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('banner-delete')): ?>
                                            <form action="<?php echo e(route('banners.destroy', $info->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/ayla/resources/views/admin/banners/index.blade.php ENDPATH**/ ?>