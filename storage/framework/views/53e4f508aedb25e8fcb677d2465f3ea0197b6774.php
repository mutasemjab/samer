...
<div class="card">
    <div class="card-header">
        <h3 class="card-title card_title_center"> <?php echo e(__('messages.categories')); ?> </h3>
        <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-sm btn-success"> <?php echo e(__('messages.New')); ?> <?php echo e(__('messages.categories')); ?></a>
        ...
        <div id="ajax_responce_serarchDiv" class="col-md-12">
            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead class="custom_thead">
                    ...
                    <th><?php echo e(__('messages.Parent Category')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($info->parentCategory->name_ar ?? null); ?></td>
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category-edit')): ?>
                            <a href="<?php echo e(route('categories.edit', $info->id)); ?>" class="btn btn-sm  btn-primary"><?php echo e(__('messages.Edit')); ?></a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category-delete')): ?>
                            <form action="<?php echo e(route('categories.destroy', $info->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/ayla/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>