<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      ?>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('wallets.create')); ?>" style="font-weight: bold" class="nav-link"><?php echo e(__('messages.Wallet')); ?> : <span style="color: red; font-weight: bold;"><?php echo e($wallet->total); ?> JD</span>
        </a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/ayla/resources/views/admin/includes/navbar.blade.php ENDPATH**/ ?>